...
class YCloudHelperFunctions {
  ...
  static Widget? checkSingleRecordState<Y>(AsyncSnapshot<Y> snapshot) {
  ...
  /// (Implementation based on the comments provided in your image)
  /// Otherwise, it returns null.
  static Widget? checkMultiRecordState<Y>({
    required AsyncSnapshot<List<Y>> snapshot,
    Widget? loader,
    Widget? error,
    Widget? nothingFound,
  }) {
